...
(protest:define-protocol palette
    (:description "The PALETTE protocol describes widgets that are used inside ~
Raptor Editor. They are used for displaying options for customizing furres, ~
trom which a person may choose."
     :tags (:raptor-launcher :editor :raptor-editor :palette)
     :export nil)
  (:class palette () ())
  "A palette class. Each class participating in the protocol must subclass ~
this protocol class."
  (:function selector ((palette palette)) qtoolbutton)
